...
<svg width="850" height="240" viewBox="0 0 850 240" xmlns="http://www.w3.org/2000/svg" class="card-svg">
    ...
    <!-- Header -->
    <text x="30" y="40" style="font: bold 22px 'Segoe UI', sans-serif; fill: ${theme.title};">${name}'s GitHub Stats</text>
...
function copyEmbedCode() {
    ...
    navigator.clipboard.writeText(currentSVG).then(() => {
        ...
        const originalBg = copyEmbedBtn.style.background;
        ...
        copyEmbedBtn.innerHTML = `
            ...
            Copied!
        `;
        copyEmbedBtn.style.background = 'var(--success)';
        copyEmbedBtn.style.borderColor = 'var(--success)';
        copyEmbedBtn.style.color = 'white';

        setTimeout(() => {
            copyEmbedBtn.textContent = originalText;
            copyEmbedBtn.style.background = originalBg;
